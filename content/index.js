export const content = {
  homePage: {
    ...
    testimonials: [
      {
        description:
          "“Arcu mattis vel nunc in. Metus pretium egestas fermentum ut adipiscing vitae lorem nulla varius. Lectus risus posuere libero nulla. Nec tempor ut dolor vulputate nisl. Egestas aliquet in ac us. Lectus risus posuere libero nulla. Nec tempor ut dolor vulputate nisl. Egestas aliq sit consequat ”",
    ...
    cardContent: [
      {
        ...
        description:
          "All of our teams follow Scrum methodology, which has proven to give great results and helps to keep all project stakeholders in sync.",
        imgPath: "/assets/home/agileDevelopment.svg",
      },
      {
        title: "Teamwork",
        description:
          "Having regular knowledge sharing sessions, code reviews and daily standups means all the team members are well aligned and no one needs to reinvent the wheel when it comes to implementing a similar feature to already existing ones.",
        imgPath: "/assets/home/teamwork.svg",
      },
      {
        title: "Fully devoted to the Project",
        description:
          "The secret to success is the balance between enjoying what you do and taking the responsibility to do it in the most adept way. Even though we already have people on 24/7 support.",
  ...
  blogPage: {
    heroSection: {
      ...
      subtitle:
        "At Root Level, we value innovation. Learn great innovation stories from different bloggers and get an insight into the world of computing and information technology. ",
      description:
        "Business today knows no horizon, all by the grace of technology, part of the reason why we are overtly ready to empower your business with all kinds of sophisticated tech solutions required to overcome any challenges that your business is presented with.",
      bg: "#008080",
  ...
  servicesPage: {
    heroSection: {
      title: "Services",
      subtitle:
        'The only expression that "Root" should follow is "Super! And that’s exactly the feeling we work towards extending towards our clients.',
      description:
        "The Root Level helps businesses gain a competitive edge with solutions on Mobile application, web development, and other software development services.",
      bg: "#008080",
    ...
    cards: [
      {
        ...
        imagePath: "/assets/services/icons/mobile-dev.svg",
      },
      {
        title: "Web Development",
        description:
          "Our Web development services allow your company to automate processes and create web platforms for effective branding. Our design and development team offers your business a variety of services including web development, custom web apps development, UI/UX design, and SEO-friendly web design. ",
        imagePath: "/assets/services/icons/web-dev.svg",
      },
      {
        title: "Enterprise Software Development",
        description:
          "We provide enterprise software development services with the adoption of advanced technologies delivering digital solutions for your business that drives efficiency and productivity. Our team takes time to understand your digital needs and build customized digital solutions to integrate with your business process.",
        imagePath: "/assets/services/icons/enterprise-software-dev.svg",
      },
      {
        ...
        imagePath: "/assets/services/icons/machine-learning.svg",
      },
      {
    ...
    imageInfoSection: [
      ...
      {
        imageURL: "/assets/services/imageInfo/quality-assurance.png",
        title: "Testing",
      ...
      {
        imageURL: "/assets/services/imageInfo/launch.png",
        title: "Deployment",
  ...
  contactPage: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "This is a great question to ask and you should ask it of any web design and development firm you are considering. Our clients work directly with our experienced team. The team will depend on your project needs and what stage of the process you are in during the project. The team members will remain involved from start to finish.",
      },
      {
        question: "What platform do you build your websites on?",
        answer:
          "We build our project on the Django web framework of Python. Our front-end technologies are HTML, CSS and JavaScript(React JS). We also build websites on the Open-source Content Management System Platform.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Here at RootNepal, We are all goal oriented professionals  with a plethora of experience in developing mobile, desktop, and web applications to suit your needs near perfectly.",
      },
      {
        question: "How do I create a product with your company?",
        answer:
          "Browse through the How we work section on the Services page and get a thorough insight on how the product will be built. Hesitate not to contact us for any queries.",
      },
      {
        question: "Why should you trust us?",
        answer:
          "As stated for a myriad of times, we are professionals of the field, very adept at doing what we do.  Room for errors, we got none!",
      },
      {
  ...
  aboutPage: {
    heroSection: {
      title: "Who are we?",
      subtitle:
        "Root Level is a technology services company delivering products, solutions, and systems that empower your business.",
      description:
        "We empower companies with our industry-standard digital solutions. Our team of dedicated developers, engineers, and designers deliver end-to-end fully equipped software solutions for your business.",
      bg: "#008080",
    ...
    sections: [
      {
        imageURL:
          "https://images.unsplash.com/photo-1521316730702-829a8e30dfd0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80",
        isImageRight: false,
        tag: "Our Mission",
        title: "Transform Ideas to products",
        description:
          "Our mission is to work with businesses by reimagining their business conduction process with technology adoption that drives scalable and competitive results. We work with business and clients to build software products centralized around your needs and produce technology solutions that improve your internal processes and contribute to profitability.",
      },
      {
        imageURL:
          "https://images.unsplash.com/photo-1517048676732-d65bc937f952?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
        isImageRight: true,
        tag: "Our Vision",
        title: "Leaders of Tomorrow",
        description:
          "Our vision is in pursuing pure perseverance and innovation, we visualize ourselves as the leaders of tomorrow in our field of technology and embody the epitome of excellency.",
      },
      {
        imageURL:
          "https://images.unsplash.com/photo-1517048676732-d65bc937f952?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
        ...
        description:
          "Our goal is to facilitate our clients with A-class IT solutions, enabling them to take full control of their business and their fate. It is our duty to spark the flame that will change the world for better.",
      },
    ],
  },
  careerPage: {
    heroSection: {
      title: "Career",
      subtitle:
        "March, not work with us as we build the future of software. Here, you get to infuse your ingenuity into your work all the while passionately serving your clients.",
      description:
        "The quality of our work has always been the symbolic character of our company. Committed to customer satisfaction, we take pride in craftsmanship and believe in making the difference.",
      bg: "#008080",
